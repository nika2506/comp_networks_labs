...
class DesignatedRouter:
    def __init__(self, screen_centre, screen_height):
        self.sensors_num = 4
        self.sensor_1 = Sensor(*calculateSensorParameters(1, screen_centre, screen_height), sensor_id=1)
        self.sensor_2 = Sensor(*calculateSensorParameters(2, screen_centre, screen_height), sensor_id=2)
        self.sensor_3 = Sensor(*calculateSensorParameters(3, screen_centre, screen_height), sensor_id=3, swindler=True)
        self.sensor_4 = Sensor(*calculateSensorParameters(4, screen_centre, screen_height), sensor_id=4)
